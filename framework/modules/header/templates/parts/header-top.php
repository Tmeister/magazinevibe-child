...
<?php do_action('magazinevibe_edge_before_header_top'); ?>

<div class="edgtf-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="edgtf-grid">
    <?php endif; ?>
		<?php do_action( 'magazinevibe_edge_after_header_top_html_open' ); ?>
...
<?php do_action('magazinevibe_edge_after_header_top'); ?>
