...
if ( ! function_exists('magazinevibe_edge_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function magazinevibe_edge_footer_options_map() {
		...
		$footer_panel = magazinevibe_edge_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = magazinevibe_edge_add_admin_container(
			array(
		...
		$show_footer_bottom_container = magazinevibe_edge_add_admin_container(
			array(
	...
	add_action( 'magazinevibe_edge_options_map', 'magazinevibe_edge_footer_options_map', 10);
}