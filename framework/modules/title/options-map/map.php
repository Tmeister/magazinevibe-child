...
if ( ! function_exists('magazinevibe_edge_title_options_map') ) {

	function magazinevibe_edge_title_options_map() {
		...
		$panel_title = magazinevibe_edge_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
		...
		$show_title_area_container = magazinevibe_edge_add_admin_container(
			array(
				'parent' => $panel_title,
		...
		$title_area_background_image_responsive_container = magazinevibe_edge_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$panel_typography = magazinevibe_edge_add_admin_panel(
			array(
				'page' => '_title_page',
		...
		$group_page_breadcrumbs_styles = magazinevibe_edge_add_admin_group(array(
		...
		$row_page_breadcrumbs_styles_1 = magazinevibe_edge_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_2 = magazinevibe_edge_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_3 = magazinevibe_edge_add_admin_row(array(
	...
	add_action( 'magazinevibe_edge_options_map', 'magazinevibe_edge_title_options_map', 6);
}