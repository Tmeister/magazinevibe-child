<?php
namespace MagazineVibe\Modules\Blog\Shortcodes\PostLayoutOne;
...
class PostLayoutOne extends ListShortcode {
    ...
    public function __construct() {
		$this->base = 'edgtf_post_layout_one';
        $this->css_class = 'edgtf-post-layout-one';
        $this->shortcode_title = 'Edge Post Layout 1';
