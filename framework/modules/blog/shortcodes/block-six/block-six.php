<?php
namespace MagazineVibe\Modules\Blog\Shortcodes\BlockSix;
...
class BlockSix extends ListShortcode
{
    ...
    public function __construct() {
        $this->base = 'edgtf_block_six';
        $this->css_class = 'edgtf-block-six';
        $this->shortcode_title = 'Edge Block 6';
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            ...
            while ($atts['query_result']->have_posts()) : $atts['query_result']->the_post();
                ...
                if($loop_counter == 1){
                    $html .= '<li class="edgtf-block-six-featured">';
                    ...
                    $html .= '</li>';
                    $html .= '<li class="edgtf-block-six-non-featured">';
                } else {
                    //Get HTML from template
