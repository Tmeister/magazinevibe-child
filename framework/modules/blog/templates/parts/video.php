...
<?php if($_video_type == "youtube") { ?>
	<iframe  src="http://www.youtube.com/embed/<?php echo esc_attr(get_post_meta(get_the_ID(), "edgtf_post_video_id_meta", true));  ?>?wmode=transparent" wmode="Opaque" width="1100" height="684" allowfullscreen></iframe>
<?php } elseif ($_video_type == "vimeo"){ ?>
	<iframe src="http://player.vimeo.com/video/<?php echo esc_attr(get_post_meta(get_the_ID(), "edgtf_post_video_id_meta", true));  ?>?title=0&amp;byline=0&amp;portrait=0" width="1100" height="684" allowFullScreen></iframe>
