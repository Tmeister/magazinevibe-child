...
if ( ! function_exists('magazinevibe_edge_contact_form_7_options_map') ) {

	function magazinevibe_edge_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = magazinevibe_edge_add_admin_panel(array(
		...
		$typography_text_group = magazinevibe_edge_add_admin_group(array(
		...
		$typography_text_row1 = magazinevibe_edge_add_admin_row(array(
		...
		$typography_text_row2 = magazinevibe_edge_add_admin_row(array(
		...
		magazinevibe_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> 'Font Style',
			'options'		=>  magazinevibe_edge_get_font_style_array()
		));
		...
		magazinevibe_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> 'Font Weight',
			'options'		=> magazinevibe_edge_get_font_weight_array()
		));
		...
		magazinevibe_edge_add_admin_field(array(
			...
			'options'		=> magazinevibe_edge_get_text_transform_array()
		));

		$typography_text_row3 = magazinevibe_edge_add_admin_row(array(
		...
		$typography_label_group = magazinevibe_edge_add_admin_group(array(
		...
		$typography_label_row1 = magazinevibe_edge_add_admin_row(array(
		...
		$typography_label_row2 = magazinevibe_edge_add_admin_row(array(
		...
		$background_border_group = magazinevibe_edge_add_admin_group(array(
		...
		$background_border_row1 = magazinevibe_edge_add_admin_row(array(
		...
		$background_border_row2 = magazinevibe_edge_add_admin_row(array(
		...
		$background_border_row3 = magazinevibe_edge_add_admin_row(array(
		...
		$padding_group = magazinevibe_edge_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = magazinevibe_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = magazinevibe_edge_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = magazinevibe_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = magazinevibe_edge_add_admin_group(array(
		...
		$button_typography_row1 = magazinevibe_edge_add_admin_row(array(
		...
		$button_typography_row2 = magazinevibe_edge_add_admin_row(array(
		...
		$button_background_border_group = magazinevibe_edge_add_admin_group(array(
		...
		$button_background_border_row1 = magazinevibe_edge_add_admin_row(array(
		...
		$button_background_border_row2 = magazinevibe_edge_add_admin_row(array(
		...
		$button_background_border_row3 = magazinevibe_edge_add_admin_row(array(
		...
		$panel_contact_form_style_2 = magazinevibe_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'magazinevibe_edge_options_map', 'magazinevibe_edge_contact_form_7_options_map', 15);
}