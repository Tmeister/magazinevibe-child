<?php
namespace MagazineVibe\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Edge Custom Font', 'magazinevibe'),
				'base' => $this->getBase(),
				'category' => 'by EDGE',
				...
				'params' => array(
					...
					array(
						...
						"value" => magazinevibe_edge_get_font_style_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
						...
						"value" => magazinevibe_edge_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => magazinevibe_edge_get_text_transform_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
	...
	public function render($atts, $content = null) {
		...
		$html = magazinevibe_edge_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
