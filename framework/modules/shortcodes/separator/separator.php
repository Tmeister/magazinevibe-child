<?php
namespace MagazineVibe\Modules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Edge Separator', 'magazinevibe'),
				'base' => $this->base,
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = magazinevibe_edge_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(magazinevibe_edge_string_ends_with($params['width'], '%') || magazinevibe_edge_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(magazinevibe_edge_string_ends_with($params['top_margin'], '%') || magazinevibe_edge_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(magazinevibe_edge_string_ends_with($params['bottom_margin'], '%') || magazinevibe_edge_string_ends_with($params['bottom_margin'], 'px')) {
