<?php
namespace MagazineVibe\Modules\Tab;
...
class Tab implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Tab', 'magazinevibe'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$output = '';
		$output .= magazinevibe_edge_get_shortcode_module_template_part('templates/tab_content','tabs', '', $params);
		return $output;
